...
public class ResVO implements Serializable  {
	...
	public ResVO(Integer resId, Integer resCategory, String resAccount, Timestamp updateTime, String resName,
			...
			Integer zipCode, Time bzOpenHours, Time bzCloseHours, String bzWeekTime, Integer status) {
		super();
		this.resId = resId;
	...
	public String getBzWeekTime() {
		return bzWeekTime;
	}
	public void setBzWeekTime(String bzWeekTime) {
		this.bzWeekTime = bzWeekTime;
	}
