...
@WebServlet("/ShowPromote")
public class ShowPromote extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			Map<String, Object> promoteMap = service.showPromote();
			
			// add the list into json format
			respObj.add("promoteMap", gson.toJsonTree(promoteMap));
		} catch (Exception e) {
			e.printStackTrace();
