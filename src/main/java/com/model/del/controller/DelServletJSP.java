...
//
//@WebServlet("del.do")
//public class DelServletJSP extends HttpServlet {
//
...
//
//				/***************************1.接收請求參數 - 輸入格式的錯誤處理**********************/
//				String str = req.getParameter("delID");
...
//				DelVO delVO = delSvc.getOneDel(delID);
//				if (delVO == null) {
//					errorMsgs.add("查無資料");
//				}
//				// Send the use back to the form, if there were errors
...
//				req.setAttribute("delVO", delVO); // 資料庫取出的empVO物件,存入req
