 ...
 */
@WebServlet("/DelEditBank")
public class DelEditBank extends HttpServlet {
...
//登入狀態下取出登入者資料
		...
		delVO.setDelAccountName(editDelVO.getDelAccountName());
		delVO.setDelBankname(editDelVO.getDelBankname());
		delVO.setDelBankcode(editDelVO.getDelBankcode());
		delVO.setDelBankaccount(editDelVO.getDelBankaccount());
